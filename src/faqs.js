import country from './Components/common/Image/London.jpeg'
import country1 from './Components/common/Image/New York.jpeg'
import country2 from './Components/common/Image/Amsterdam.jpeg'
import country3 from './Components/common/Image/Los Angeles.jpeg'
...
//  main menu
 ...
 export const menuItem = [

  {
    title: 'Home page',
    path: '/about',
    content: 'FIRST PLACE WHEN CLICKED ON SHOWS 001',
    // sub menu
    submenu: [
      {title: 'web design',
      url: 'web-design',
  ...
  },
  {
    title: 'Services',
    path: '/about',
    content: 'SECOND PLACE WHEN CLICKED ON SHOWS 002',
  },
  {
    title: 'About-items',
    path: '/about',
    content: 'THIRD PLACE WHEN CLICKED ON SHOWS 002',
  },
 ]
